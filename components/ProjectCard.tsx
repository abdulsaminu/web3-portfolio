...
export default function ProjectCard({
  ...
  return (
    <div className="card group">
      ...
      <h3 className="text-[10px] font-bold mb-2 tracking-tight">{title}</h3>
      ...
      <div className="flex gap-4 text-sm">
        ...
        {demo && (
          <a href={demo} target="_blank" rel="noopener noreferrer" className="text-red-600 hover:text-red-700" aria-label="Watch demo on YouTube">
